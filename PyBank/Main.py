# Main.py - PyBank  Analyze financial records for the company. 
# Authored by Verna Orsatti May 2018 for University of Denver: DataAnalytics Bootcamp
#     Interactive additional code for anyone to use this in the future as decribed
#     assignment requirements.

# 2 sets of revenue data: 
# budget_data_1.csv  Jeff said not to reformat dates when in different form
# budget_data_2.csv
...
# Here's to good weather, good friends and good purpose in life
# And here's to you for reading this!